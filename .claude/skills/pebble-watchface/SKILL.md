...
**Default target platform for THIS repo: basalt (Pebble Time, 144x168 color rectangular display) — the owner's watch. See CLAUDE.md.** (Upstream skill default was emery.)
